...
from ldm.util import instantiate_from_config, is_cuda_device, resolve_device
import yaml
from omegaconf import OmegaConf
...
def evaluate_tokenizer(config_path, model_name, data_path, output_path, ckpt_path, device="auto"):
...
if __name__ == "__main__":
    ...
    evaluate_tokenizer(config_path=args.config_path, model_name=args.model_name, data_path=args.data_path, output_path=args.output_path, ckpt_path=args.ckpt_path, device=args.device)
