...
DATA_DIR = "/workspace/VAE-Traversals/train_traversals/experiments/GAT-ResNet-K100-D20__20260706_222452/vp_pairs"  # TODO: set this

# Where to store VP training logs/checkpoints
RESULT_DIR = "/workspace/VAE-Traversals/train_traversals/experiments/GAT-ResNet-K100-D20__20260706_222452/vp_results"  # TODO: set this
...
def main():
    parser = argparse.ArgumentParser(description="Run VP metric for GAT")
    parser.add_argument(
        "--data_dir",
        type=str,
        default=DATA_DIR,
