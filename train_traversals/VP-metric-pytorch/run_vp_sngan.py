...
# -*- coding: utf-8 -*-
"""
Run VP metric for an SNGAN model by calling `main_vp.py` with the
...
DATA_DIR = "/workspace/experiments/complete/SNGAN_AnimeFaces-LeNet-K64-D19__20251219_152949/vp_pairs"

# Where to store VP training logs/checkpoints
RESULT_DIR = "/workspace/experiments/complete/SNGAN_AnimeFaces-LeNet-K64-D19__20251219_152949/vp_results"  # TODO: set this

IN_CHANNELS = 6          # must match input channels expected by VarPred
INPUT_MODE = "concat"      # "diff" or "concat"
OUT_DIM = 64             # #directions / latent dim for SNGAN
LR = 0.005
BATCH_SIZE = 32
EPOCHS = 300
TEST_RATIO = 0.9         # 10% train / 90% test
WORKERS = 4


def main():
    parser = argparse.ArgumentParser(description="Run VP metric for SNGAN")
    parser.add_argument(
        "--data_dir",
        type=str,
        default=DATA_DIR,
