...
# -*- coding: utf-8 -*-
"""
Run VP metric for a StyleGAN2 model by calling `main_vp.py` with the
...
DATA_DIR = "/workspace/experiments/wip/StyleGAN2-256-W-ResNet-K200-D20__20260107_064603/vp_pairs"  # TODO: set this
DATA_DIR = "/workspace/experiments/wip/StyleGAN2-256-W-ResNet-K200-D20__20260628_145750/vp_pairs"  # TODO: set this


# Where to store VP training logs/checkpoints
RESULT_DIR = "/workspace/experiments/wip/StyleGAN2-256-W-ResNet-K200-D20__20260107_064603/vp_results"  # TODO: set this
RESULT_DIR = "/workspace/experiments/wip/StyleGAN2-256-W-ResNet-K200-D20__20260628_145750/vp_results"  # TODO: set this

IN_CHANNELS = 6          # must match input channels expected by VarPred
INPUT_MODE = "concat"      # "diff" or "concat"
OUT_DIM = 200            # number of support sets for StyleGAN2
LR = 0.005
BATCH_SIZE = 32
EPOCHS = 300
...
def main():
    parser = argparse.ArgumentParser(description="Run VP metric for StyleGAN2")
    parser.add_argument(
        "--data_dir",
        type=str,
        default=DATA_DIR,
