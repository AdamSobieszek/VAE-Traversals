...
# -*- coding: utf-8 -*-
"""
Run VP metric for a VAE model by calling `main_vp.py` with the
...
DATA_DIR = "/path/to/vae_vp_pairs"  # TODO: set this

# Where to store VP training logs/checkpoints
RESULT_DIR = "/path/to/vae_vp_results"  # TODO: set this

IN_CHANNELS = 3          # must match input channels expected by VarPred
INPUT_MODE = "diff"      # "diff" or "concat"
OUT_DIM = 30             # #directions / latent dim for this VAE
LR = 0.005
BATCH_SIZE = 32
EPOCHS = 300
...
def main():
    parser = argparse.ArgumentParser(description="Run VP metric for VAE")
    parser.add_argument(
        "--data_dir",
        type=str,
        default=DATA_DIR,
